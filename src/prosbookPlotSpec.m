function ps = prosbookPlotspec(overallGain)
  ...
  ps  =[{'self'}, {'vo'}, {'Intensity'},  175, ygain, dustyPurple, {'-'}; ...  
	...
	{'self'}, {'le'}, {'Lengthening'}, 145, ygain, dustyPurple, {'-'}; ...
	{'self'}, {'cr'}, {'Creakiness'},  135, ygain, dustyPurple, {'-'}; ...
	{'self'}, {'pd'}, {'Disalignment'},125, ygain, dustyPurple, {'-'}; ...
	{'self'}, {'ap'}, {'Articu. Prec.'},115, ygain, gray, {'-'}; ...
	...
	{'self'}, {'ap'}, {'Articu. Prec.'},30, ygain, dustyPurple, {'-'}; ...
