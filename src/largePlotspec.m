...
%  all should have the same gain, 25.
  ...
  ps  =[{'self'}, {'vo'}, {'Intensity'},  235, 25, dustyPurple, {'-'}; ...
	{'self'}, {'cr'}, {'Creakiness'}, 225, 25, dustyPurple, {'-'}; ...
	{'self'}, {'sr'}, {'S. Rate'},    215, 25, dustyPurple, {'-'}; ...
	{'self'}, {'ph'}, {'Pitch Height'},205, 25, dustyPurple, {'-'}; ...
	{'self'}, {'pr'}, {'Pitch Range'}, 195, 25, dustyPurple, {'-'}; ...
	{'self'}, {'le'}, {'Lengthening'}, 185, 25, dustyPurple, {'-'}; ...
	{'self'}, {'pd'}, {'Disalignment'},175, 25, dustyPurple, {'-'}; ...
	{'self'}, {'sf'}, {'Speaking Frac.'},165, 25, dustyPurple, {'-'}; ...
	{'self'}, {'vf'}, {'Voicing Frac.'},155, 25, dustyPurple, {'-'}; ...
	{'self'}, {'en'}, {'Enunciation'},145, 25, dustyPurple, {'-'}; ...
	{'self'}, {'re'}, {'Reduction'},  135, 25, dustyPurple, {'-'}; ...  
		...
	...
	{'inte'}, {'sf'}, {'Speaking Frac.'},40, 25, darkGreen, {'-'}; ...
	{'inte'}, {'vf'}, {'Voicing Frac.'},30, 25, darkGreen, {'-'}; ...
	{'inte'}, {'en'}, {'Enunciation'}, 20, 25, darkGreen, {'-'}; ...
	{'inte'}, {'re'}, {'Reduction'},  10, 25, darkGreen, {'-'}; ...
       ];
end
