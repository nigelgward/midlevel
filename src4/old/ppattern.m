function done  =  ppattern(path,dimension)  
% ppattern.m
...
selfvol = zeros(xspan,1);
othervol = zeros(xspan,1);
selfsr  = zeros(xspan,1);
othersr = zeros(xspan,1);
selfcr  = zeros(xspan,1);
othercr = zeros(xspan,1);
selflp  = zeros(xspan,1);
otherlp = zeros(xspan,1);
selfhp = zeros(xspan,1);
otherhp = zeros(xspan,1);
selffp  = zeros(xspan,1);
otherfp = zeros(xspan,1);
selfnp  = zeros(xspan,1);
othernp = zeros(xspan,1);
selftp  = zeros(xspan,1);
othertp = zeros(xspan,1);
selfwp  = zeros(xspan,1);
otherwp = zeros(xspan,1);

%wrf,wju,wmi,frf,fju,fmi

selfrf  = zeros(xspan,1);
otherrf = zeros(xspan,1);
selfju  = zeros(xspan,1);
otherju = zeros(xspan,1);
selfmi  = zeros(xspan,1);
othermi = zeros(xspan,1);



timepoints = zeros(xspan,1);
