...
do {\tt addpath} for {\tt midlevel/src} and {\tt
...
choosing these specific features and these specific implementations are
...
Version 7.1, May 2019.  I incorporated the all needed functions from
Voicebox for audio file input and the pitch computation.
%, available from {\tt
