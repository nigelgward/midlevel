...
We calse the energy to normalize for individual differences and
...
Fix the two known bugs (the {\tt vr} and {\tt le} features can be
meaningless over the first few tens of milliseconds of a file)
